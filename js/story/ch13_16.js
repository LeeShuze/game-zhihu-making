...
window.STORY_CH13_16 = {
  ...
  beats: [
    ...
    {
      type: "narration",
      text: "刚抵达 29 层，我礼貌地敲门，才敲一声，门就开了。",
      clearSprites: true,
      progress: "§13 29 层",
    },
    ...
    {
      type: "narration",
      text: "通过群消息得知，这层的玩家早就嘎了。",
    },
    { type: "horror", set: 14 },
    { type: "scene", scene: "floor29_living" },
    {
      type: "narration",
      text: "门内露出一对龙凤胎姐弟的脸，他们看着似乎是少年模样，警惕地看了看我手里的道具，尤其是那把钝了的菜刀，讨好地对我抿唇微笑——",
    },
    {
      type: "say",
      speaker: "龙凤胎姐姐",
    ...
    {
      type: "narration",
      text: "如果不是他们碎掉的脑袋，还有辨别不出形状的五官和发臭的衣服，肯定更有亲和力。\n我捏住朴素的卡片，卡片上只有一点点黑色的图案，看不出具体是什么。",
      clearSprites: true,
    },
    {
      type: "narration",
      text: "我对他们姐弟道了谢，然后礼貌地询问——",
    },
    {
      type: "say",
      speaker: "宁念",
    ...
    {
      type: "narration",
      text: "是的，其实刚进入这个恐怖游戏时，站在楼底下那会，我并不是什么也没干。\n在所有人都跑去找抢夺楼层之后，我无聊地围着大楼转了五圈——\n终于在黑气萦绕的垃圾堆里，在一堆不知道是什么黏液的呕吐物里，翻出来一张脏污废旧的报纸。",
      clearSprites: true,
    },
    {
      type: "narration",
      text: "幸好，这是我这种社会底层的老本行。\n我是孤儿，小时候最常干的事情就是翻垃圾堆，看看有没有可以吃的可以用的。\n而这种地方，都是容易被玩家们忽略的。更何况，他们急着去抢楼层，根本没想过楼外面也会有东西。",
    },
    {
      type: "narration",
      text: "我毫不嫌弃地凑到报纸前面，仔细看着，我看见上面清楚地记录着「幸福之家」副本 30 个诡异进来的原因，还附带着他们的照片。",
    },
    { type: "horror", set: 8 },

    // —— 14 姐弟的故事 ——
    { type: "danmaku", text: "我靠，我错过了什么？之前这姐们在趴在地上翻垃圾堆，我以为她饿了。" },
    { type: "danmaku", text: "不怪你，怪直播间当时死活不切近景，我们都没看见她手里的报纸，以为她在吃垃圾。" },
    { type: "danmaku", text: "反思一下，为什么那份报纸，宁神一个近视眼都能看到，我们却看不到。" },
    ...
    {
      type: "narration",
      text: "因为他们的爸爸是入赘，所以一直想谋夺他们妈妈的财产。\n最后为了防止两个孩子成年继承家产，情妇出此毒计，亲爸点头通过。",
    },
    {
      type: "narration",
    ...
    {
      type: "narration",
      text: "那时，她在网上刷到了一件好看的衣服，于是就以图找图，买了同款，美滋滋地拍了照片上传到社交平台。\n然后，她迎来上万条辱骂。说她没有戴假发，说她没有化妆，说她不尊重二次元，说她辱没了 cos 圈，拉低了 coser 的档次，说她就不应该活着。\n最后还对她的朋友、父母进行个人信息开盒，疯狂骚扰她的父母和亲朋好友，P 她的遗照和黄图传给父母。",
    },
    {
      type: "narration",
      text: "女孩慌了，也怕了，她不懂什么 cos 不 cos，也不懂什么圈子不圈子。她当时只是单纯地觉得，那件衣服很漂亮，她想买来穿一穿。\n可后来她觉得，她有罪。她应该以死，结束这场罪恶。\n甚至在吞安眠药之前，她都穿着那件衣服，化了全妆，戴了假发。她就想着，万一到了阴曹地府，又遇到圈子里的人，再被骂一顿，甚至不准她投胎转世就不好了。",
    },
    { type: "horror", set: 18 },
    {
      type: "narration",
    ...
    },
    {
      ...
      sprite: "assets/chars/ningnian_coat_dress.png",
      side: "right",
      text: "这里没有任何圈子，只有生与死。所以，在这里，你可以想穿什么衣服就穿什么衣服，想素颜就素颜，想浓妆就浓妆。等他们死后万一来了这里，你也可以疯狂折磨他们。\n当然，我认为，他们那些人，即使死了，也是不配再拥有一次复活机会的。",
      slots: [
        { side: "left", sprite: "assets/chars/girl28_front.png", name: "28层女孩" },
        { side: "right", sprite: "assets/chars/ningnian_coat_dress.png", name: "宁念" },
      ],
